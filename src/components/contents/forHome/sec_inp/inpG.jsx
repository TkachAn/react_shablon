      ...
      <Flex>
        ...
        <div style={{ flex: 1 }}>
          ...
          <Article title="Email и Безопасность" id="auth-fields">
            ...
            <p>
              При включении параметра <b>confirm</b>, под основным полем появляется
              второе. Компонент не пропустит форму, пока значения не совпадут.
            </p>
            ...
            <div className={s.demoBox}>
              ...
              <p>
                ...
                email и какой минимальной длины должен быть пароль (от 8
                символов).
              </p>
